...
mkdir /system/etc/nomagic/sus 2>/dev/null
chmod 1733 /system/etc/nomagic/sus
mkdir /system/etc/nomagic/sureq 2>/dev/null
chmod 1733 /system/etc/nomagic/sureq
mkdir /system/etc/nomagic/pidverif 2>/dev/null
chmod 1733 /system/etc/nomagic/pidverif
mkdir /system/etc/nomagic/cmds 2>/dev/null
